                            ...
                            <header
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="hidden md:ml-4 md:flex md:items-center">
                                        <div class="relative">
                                            <button aria-controls="Event" data-collapse-toggle="Event" type="button"
                                    ...
                                    -->
                                            <div id="Event"
                                                class="absolute right-0 z-10 mt-3 w-36 origin-top-right overflow-hidden hidden rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                                                ...
                                                <div class="py-1" role="none">
                                                    ...
                                                    <a href="#" class="text-gray-700 block px-4 py-2 text-sm"
                                                        role="menuitem" tabindex="-1" id="menu-item-3">Year view</a>
                                                </div>
                                            </div>
                                        </div>
                                  ...
                                  -->
                                        <div class="absolute right-0 z-10 mt-3 w-36 origin-top-right divide-y divide-gray-100 overflow-hidden rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                                            ...
                                            <div class="py-1" role="none">
                                                <!-- Active: "bg-gray-100 text-gray-900", Not Active: "text-gray-700" -->
                                                <a href="#" class="text-gray-700 block px-4 py-2 text-sm"
                                                    role="menuitem" tabindex="-1" id="menu-0-item-0">Create
                                                    event</a>
                                            </div>
                                            <div class="py-1" role="none">
                                                <a href="#" class="text-gray-700 block px-4 py-2 text-sm"
                                            ...
                                            <div class="py-1" role="none">
                                                ...
                                                <a href="#" class="text-gray-700 block px-4 py-2 text-sm"
                                                    role="menuitem" tabindex="-1" id="menu-0-item-3">Week view</a>
                                                <a href="#" class="text-gray-700 block px-4 py-2 text-sm"
                                ...
                                <ol
                                    ...
                                    <li class="group flex p-4 pr-6 focus-within:bg-gray-50 hover:bg-gray-50">
                                        <div class="flex-auto">
                                            ...
                                            <time datetime="2022-01-15T09:00"
